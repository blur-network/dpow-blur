...
`sudo pacman -S base-devel cmake boost openssl libsodium libunwind binutils libevent autoconf readline`

Fedora One-Liner: 

`sudo dnf install cmake boost-devel openssl-devel sodium-devel libunwind-devel binutils-devel libevent-devel autoconf readline-devel`
